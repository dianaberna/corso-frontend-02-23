console.log("v2 - lista attributi link in un array di strighe")
...
let arrayHrefLink = ["index.html", "why.html", "how.html"]

for (let i = 0; i < arrayLink.length; i++) {
    let li = document.createElement("li")
    let testoLink = document.createTextNode(arrayLink[i])
    let link = document.createElement("a")
    link.setAttribute("href", arrayHrefLink[i])
