...
//ES.21 Convertitore di date

function convertitoreDate(date,tipo=completa){// se tipo non viene specificato visualizzare anno completo
 
    if(tipo=="completa"){
        return date[3]+date[4]+"/"+date[0]+date[1]+"/"+date[6]+date[7]+date[8]+date[9];
    } else{
        return date[3]+date[4]+"/"+date[0]+date[1]+"/"+date[8]+date[9];
    }
